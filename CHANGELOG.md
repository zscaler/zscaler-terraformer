...
- [PR #414](https://github.com/zscaler/zscaler-terraformer/pull/414) - Fixed ZIA `zia_dlp_web_rules` nested attribute conversions to auto-generate data sources with name lookup.
...
- [PR #412](https://github.com/zscaler/zscaler-terraformer/pull/412) - ZPA and ZIA data sources in the generated `datasource.tf` (e.g. `zpa_server_group`, `zpa_segment_group`, `zpa_ba_certificate`, `zia_location_management`, `zia_firewall_filtering_ip_source_groups`, `zia_rule_labels`) are now queried by `name` instead of the raw numeric `id`, with a fallback to `id` when the name is unavailable or ambiguous.
...
- [PR #410](https://github.com/zscaler/zscaler-terraformer/pull/410) - Upgraded to [Zscaler-SDK-GO v3.8.41](https://github.com/zscaler/zscaler-sdk-go/releases/tag/v3.8.41)
...
- [PR #377](https://github.com/zscaler/zscaler-terraformer/pull/377) - Upgraded to Go SDK v3.8.20
- [PR #377](https://github.com/zscaler/zscaler-terraformer/pull/377) - Fixed incorrect data source mapping in the resource `zpa_policy_access_rule`
...
- [PR #369](https://github.com/zscaler/zscaler-terraformer/pull/369) - Upgraded to Go SDK v3.8.12
...
## **🐛 Bug Fixes**
- [PR #346](https://github.com/zscaler/zscaler-terraformer/pull/346) - Upgraded to [Zscaler GO SDK v3.8.1](https://github.com/zscaler/zscaler-sdk-go/releases/tag/v3.8.1)
